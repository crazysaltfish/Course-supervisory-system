			...
			<div class="col-md-4" id="login-box">
				<form class="form-horizontal" role="form" action="login" id="from1" method="post">
				  ...
				  <div class="form-group" style="margin-right: 15px;">
				    <div class="col-sm-offset-2 col-sm-10">
				      <a style="margin-left:0px;" href="tourist" class="btn btn-default btn-info">测试登录</a>
				      <button style="margin-left:0px;" type="submit" class="btn btn-default btn-info">用户登录</button>
				    </div>
				  </div>
				</form>
			</div>
