...
<body>
				    ...
				    <table class="table table-bordered">
							...
							<c:forEach  items="${courseList}" var="item">
								<tr>
									...
									<td>${item.score}</td>
									<td>
										<button class="btn btn-default btn-xs btn-info" onClick="location.href='gradeCourse?id=${item.courseid}'">成绩</button>
										<!--弹出框-->
									</td>
								</tr>
							</c:forEach>
	...
	<script type="text/javascript">
        ...
        function showCourseDetails(courseid){
        	location.href = "showCourseDetails_teacher?courseid="+courseid;
        }
	</script>
</html>